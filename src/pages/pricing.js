						...
						<div className="row">
							<div className="col-xl-4 col-lg-10">
								<div className="pricing-plan-content mb-65 wow fadeInUp delay-0-2s">
									...
									<p>
										Start building your first prototype in
										no time. Ogency intuitive drag &amp;
										drop interface gives you all the
										building blocks that you need to get
										started! No skills required.
									</p>
									<Nav
										className="nav pricing-tab mt-15"
										role="tablist"
									>
										<li>
											<Nav.Link
							...
							<div className="col-xl-8">
								<Tab.Content className="tab-content wow fadeInUp delay-0-4s">
									...
									<Tab.Pane
										className="tab-pane fade yearly"
										eventKey="yearly"
									>
										<div className="row">
											<div className="col-md-6">
